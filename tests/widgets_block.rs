...
#[test]
fn widgets_block_bottom_title_alignment() {
    let test_case = |alignment, borders, expected| {
        let backend = TestBackend::new(15, 2);
        let mut terminal = Terminal::new(backend).unwrap();
    ...
    // title bottom-center with all borders
    test_case(
        Alignment::Center,
        Borders::ALL,
        Buffer::with_lines(vec![" ┌───────────┐ ", " └───Title───┘ "]),
    ...
    // title bottom-center without bottom border
    test_case(
        Alignment::Center,
        Borders::LEFT | Borders::TOP | Borders::RIGHT,
        Buffer::with_lines(vec![" ┌───────────┐ ", " │   Title   │ "]),
    ...
    // title bottom-center with no left border
    test_case(
        Alignment::Center,
        Borders::TOP | Borders::RIGHT | Borders::BOTTOM,
        Buffer::with_lines(vec![" ────────────┐ ", " ────Title───┘ "]),
    ...
    // title bottom-center without right border
    test_case(
        Alignment::Center,
        Borders::LEFT | Borders::TOP | Borders::BOTTOM,
        Buffer::with_lines(vec![" ┌──────────── ", " └───Title──── "]),
    ...
    // title bottom-center without borders
    test_case(
        Alignment::Center,
        Borders::NONE,
        Buffer::with_lines(vec!["               ", "     Title     "]),
